...
2. **A four-category classification** (pattern manifestation, pattern fidelity, pattern corruption, free lunch) that organizes what faultization reveals about the system's relationship to the latent space.
